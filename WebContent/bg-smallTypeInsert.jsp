...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>
		  <form action="smallType_add.action" method="post"  name="form" onSubmit="return checkEmpty(form)" >
        <table width="90%" height="60"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr>
            ...
            <td width="75%" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;
              <select name="bigType.btId">
					<c:forEach items="${list}" var="bigType">
						<option value="${bigType.btId}">${bigType.btBigName}</option>
					</c:forEach>
			  </select>		    
		    </td>
          </tr>
           <tr>
            ...
            <td width="75%" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;
             <input name="stSmallName" type="text" size="50"></td>
          </tr>
        </table>
       <br>
