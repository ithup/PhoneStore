...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>
<form action="${pageContext.request.contextPath}/affiche_add.action" onsubmit="return checkEmpty(afficheForm)">
        <table width="90%" height="243"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr>
            ...
            <td width="77%" bgcolor="#FFFFFF"><input name="afficheName" type="text" size="55"></td>
          </tr>
          <tr>
            <td height="208"><div align="center">公告内容</div>              </td>
            <td bgcolor="#FFFFFF">
            <textarea name="afficheContent" cols="45" rows="13" class="textarea"></textarea></td>
          </tr>
      </table>
   <br>
